...
<style>
  .prose { max-width: 72ch; color: var(--text); line-height: 1.85; font-size: 1.02rem; }
  .prose :global(h1) { font-size: 2rem; letter-spacing: -0.02em; margin: 0 0 28px; }
  .prose :global(h2) { font-size: 1.4rem; margin: 64px 0 18px; letter-spacing: -0.01em; }
  .prose :global(h3) { font-size: 1.1rem; margin: 44px 0 14px; }
  ...
  .prose :global(pre) {
    ...
    padding: 16px 18px; margin: 0 0 22px; overflow-x: auto; line-height: 1.6;
  }
  ...
  .prose :global(.callout) {
    ...
    background: var(--bg-soft); padding: 16px 18px; margin: 26px 0;
  }
