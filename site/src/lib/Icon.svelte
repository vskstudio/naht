<script>
  // Inline-SVG icon set (Lucide geometry, 24×24, currentColor). No icon-font / network dependency.
  // Each entry is the inner markup of a 24×24 lucide glyph.
  let { name, size = 22, stroke = 2, class: klass = '' } = $props()

  const icons = {
    // --- legacy names kept for the landing page ---
    sync: '<path d="M4 11a8 8 0 0 1 14-5l2 2m0 0V3m0 5h-5M20 13a8 8 0 0 1-14 5l-2-2m0 0v5m0-5h5"/>',
    layers: '<path d="M12 3 2 8.5 12 14l10-5.5zM2 13.5 12 19l10-5.5M2 8.5v5m20-5v5"/>',
    git: '<path d="M12 3v7m0 4v7M5 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6m0 0v3a4 4 0 0 0 4 4h3m7-3a3 3 0 1 1 0 6 3 3 0 0 1 0-6m0 0V7"/>',
